...
/**
 * The CSVContactWriter writes a collection of contact into a CSV file in the
 * following format: firstName lastName company telephoneNumber comment
 * 
...
public class CSVContactWriter implements ContactWriter {
	...
	public void writeContacts(Collection<Contact> contacts) throws IOException {
		...
		for (Field field : fields) {	
		    writer.write(field.getName() + SEPARATOR);  
		}
